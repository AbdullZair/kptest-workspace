...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          'fixed inset-y-0 left-0 z-50 w-72 transform border-r border-neutral-200 bg-white transition-transform duration-300 ease-in-out',
      ...
      >
        ...
        <div className="flex h-16 items-center gap-3 border-b border-neutral-200 px-6">
          ...
          <div>
            ...
            <p className="-mt-1 text-xs text-neutral-500">Portal Medyczny</p>
          </div>
        </div>
        ...
        <nav className="flex-1 overflow-y-auto px-4 py-6">
          ...
          <div className="mt-8 border-t border-neutral-200 pt-6">
            ...
            <Link
              to="/help"
              className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-neutral-700 transition-colors hover:bg-neutral-100"
              onClick={onClose}
            >
              <svg
        ...
        <div className="border-t border-neutral-200 bg-neutral-50 p-4">
          <Link
            ...
            onClick={onClose}
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-primary-700 shadow-sm">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-xs text-neutral-500">{getUserRoleLabel()}</p>
            </div>
            <svg
