      ...
      <div className="flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/dashboard" className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-neutral-900 hidden sm:inline-block">KPTEST</span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 bg-error-500 rounded-full border-2 border-white" />
          </button>
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            >
              ...
              <div className="hidden md:block text-left">
                <p className="text-sm font-medium text-neutral-900">{user?.firstName || 'Użytkownik'}</p>
            ...
            {/* User menu dropdown */}
            {isUserMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-neutral-200 py-1 z-50 animate-in fade-in zoom-in-95 duration-100">
                {/* User info (mobile) */}
                <div className="md:hidden px-4 py-3 border-b border-neutral-100">
                  <p className="text-sm font-medium text-neutral-900">{user?.firstName || 'Użytkownik'}</p>
