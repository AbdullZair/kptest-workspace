...
export const EventFormModal: React.FC<EventFormModalProps> = ({
  ...
  const handleFormSubmit = (data: FormData) => {
    ...
    const endsAt = data.ends_at && data.ends_time
    ...
    if (isEditing && event) {
      ...
      } as UpdateTherapyEventRequest & { patient_id?: string })
    } else {
      onSubmit({
        ...baseData,
        project_id: projectId || '',
      } as CreateTherapyEventRequest)
    }
  }
