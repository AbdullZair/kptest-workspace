    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-600 mt-1">
              ...
              {project.created_by_name && `przez ${project.created_by_name}`}
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" className="text-rose-600 border-rose-200" onClick={handleDeleteClick}>
            <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <Card variant="outlined">
            <Card.Body>
              <h2 className="text-lg font-semibold text-neutral-900 mb-4">Informacje o projekcie</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="text-sm text-neutral-600">Nazwa</label>
                  <p className="text-neutral-900 font-medium mt-1">{project.name}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-neutral-900 font-medium mt-1">{formatDate(project.start_date)}</p>
                </div>
                <div>
                  <label className="text-sm text-neutral-600">Data zakończenia</label>
                  <p className="text-neutral-900 font-medium mt-1">{formatDate(project.end_date)}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-neutral-900 font-medium mt-1">{project.active_patient_count || 0}</p>
                </div>
              </div>
              {project.description && (
                <div className="mt-6 pt-6 border-t border-neutral-100">
                  <label className="text-sm text-neutral-600">Opis</label>
                  <p className="text-neutral-900 mt-2 whitespace-pre-wrap">{project.description}</p>
                </div>
              )}
            </Card.Body>
          </Card>
...
const QuickStatCard = ({
  ...
  return (
    <Card variant="outlined" className={`p-4 ${onClick ? 'cursor-pointer hover:shadow-md' : ''}`} onClick={onClick}>
      <div className="flex items-center gap-3">
