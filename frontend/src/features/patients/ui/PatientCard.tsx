      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <VerificationStatus status={patient.verification_status as VerificationStatusType} size="sm" />
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-2 text-sm">
            <div>
              ...
              <span className="ml-2 text-neutral-900 font-medium">{patient.pesel}</span>
            </div>
            ...
            {patient.his_patient_id && (
              <div>
                ...
                <span className="ml-2 text-neutral-900 font-mono text-xs">{patient.his_patient_id}</span>
              </div>
            )}
            ...
            {patient.email && (
              <div>
                ...
                <span className="ml-2 text-neutral-900 truncate block max-w-[150px]">{patient.email}</span>
              </div>
            )}
          </div>
