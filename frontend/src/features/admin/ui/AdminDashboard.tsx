  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <div className={clsx('w-12 h-12 rounded-xl flex items-center justify-center', iconColorStyles[color])}>
          {icon}
        </div>
...
export const AdminDashboard = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Admin Cards */}
      <div>
        <h2 className="text-lg font-semibold text-neutral-900 mb-4">Zarządzanie systemem</h2>
      ...
      <Card variant="elevated">
        <div className="flex items-center justify-between p-6 border-b border-neutral-200">
          <h2 className="text-lg font-semibold text-neutral-900">Ostatnia aktywność administratorów</h2>
...
const StatCard: React.FC<StatCardProps> = ({ title, value, trend, trendPositive, icon, isStatus }) => {
  return (
        ...
        <div>
          ...
          {trend && (
            <div className="flex items-center gap-1 mt-2">
              <svg
                className={clsx('w-3 h-3', trendPositive ? 'text-success-600' : 'text-error-600')}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <span className={clsx('text-xs font-medium', trendPositive ? 'text-success-600' : 'text-error-600')}>
                {trend}
              </span>
          ...
          {isStatus && (
            <div className="mt-2">
              <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-success-100 text-success-700">
                <span className="w-1.5 h-1.5 rounded-full bg-success-600 mr-1"></span>
                Działający
              </span>
            </div>
          )}
