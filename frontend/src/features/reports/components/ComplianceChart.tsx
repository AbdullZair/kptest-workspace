...
export const ComplianceChart = memo(function ComplianceChart({
  ...
  return (
    <div className={`relative ${className}`} style={{ height: `${chartHeight}px` }}>
      ...
      {/* Y-axis labels */}
      <div className="absolute left-0 top-0 bottom-0 flex flex-col justify-between text-xs text-neutral-500 py-8">
      ...
      {/* X-axis labels */}
      <div className="absolute left-0 right-0 bottom-0 flex justify-between text-xs text-neutral-500 px-8 pb-2">
